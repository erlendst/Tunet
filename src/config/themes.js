...
export const themes = {
  ...
  sapphire: {
    ...
    colors: {
      '--bg-primary': '#eef1fb',
      '--bg-secondary': '#f4f6fd',
      '--bg-gradient-from': '#eef1fb',
      '--bg-gradient-to': '#e8ecf8',
      '--text-primary': '#0f1535',
      '--text-secondary': '#4a5480',
      '--text-muted': 'rgba(74, 84, 128, 0.6)',
      ...STATUS_TOKENS_LIGHT,
      '--card-bg': '#ffffff',
      '--card-border': 'rgba(90, 105, 220, 0.12)',
      ...
      '--accent-color': '#5565e8',
      '--accent-foreground': '#ffffff',
      '--accent-bg': 'rgba(85, 101, 232, 0.12)',
      '--modal-border': 'rgba(90, 105, 220, 0.15)',
      '--modal-shadow': '0 20px 40px rgba(15, 21, 53, 0.1)',
      '--modal-surface': '#f0f3fc',
      '--modal-surface-hover': '#e5eaf8',
      '--modal-surface-shadow': '0 10px 24px rgba(15, 21, 53, 0.07)',
      '--modal-surface-shadow-hover': '0 14px 28px rgba(15, 21, 53, 0.1)',
    },
  },
  flat: {
    label: 'Flat',
  ...
  natural: {
    ...
    colors: {
      '--bg-primary': '#e8ede6',
      '--bg-secondary': '#f2f5f0',
      '--bg-gradient-from': '#e8ede6',
      '--bg-gradient-to': '#dfe8dc',
      '--text-primary': '#1a2e10',
      '--text-secondary': '#5a7050',
      '--text-muted': '#8aa080',
      ...STATUS_TOKENS_LIGHT,
      '--card-bg': '#ffffff',
      ...
      '--accent-color': '#2A5A3B',
      '--accent-foreground': '#ffffff',
      '--accent-bg': 'rgba(42,90,59,0.1)',
      '--modal-border': 'rgba(0,0,0,0.1)',
      '--modal-shadow': '0 8px 32px rgba(0,0,0,0.12)',
      '--modal-surface': '#f5f8f4',
      '--modal-surface-hover': '#edf2eb',
      '--modal-surface-shadow': '0 2px 8px rgba(0,0,0,0.08)',
  ...
  oled: {
    ...
    colors: {
      ...
      '--glass-border': 'transparent',
      '--modal-bg': '#000000',
      '--modal-backdrop': 'rgba(0,0,0,0.98)',
      '--accent-color': '#ffffff',
      '--accent-foreground': '#000000',
      '--accent-bg': 'rgba(255, 255, 255, 0.25)',
      '--modal-border': 'transparent',
      '--modal-border-width': '0px',
      '--modal-shadow': 'none',
      '--modal-surface': 'rgba(255, 255, 255, 0.02)',
      '--modal-surface-hover': 'rgba(255, 255, 255, 0.08)',
      '--modal-surface-shadow': 'none',
      '--modal-surface-shadow-hover': 'none',
    },
  },
